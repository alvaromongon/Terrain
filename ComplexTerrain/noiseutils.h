  ...
  namespace utils
  {
    ...
    class RendererImage
    {
      ...
      public:
		...
		/// @pre If a source river noise was specified, it has the exact same
		/// size as the source height map.
        ///
		...
		/// Renders the destination image using a portion of the contents of the source
		/// noise map and an optional background image.
		///
		/// @param initialWidthPosition The initial width position index to start rendering.
		/// @param initialHeightPosition The initial height position index to start rendering.
		/// @param width The width of the portion to render.
		/// @param height The height of the portion to render.
		///
		/// @pre SetSourceNoiseMap() has been previously called.
		/// @pre SetDestImage() has been previously called.
		/// @pre There are at least two gradient points in the color gradient.
		...
		/// the same image, although in this case, the destination image is
		/// irretrievably blended into the background image.
		void RenderPortion(int initialWidthPosition, int initialHeightPosition, int width, int height);
		...
		/// Sets the source river noise map.
		///
		/// @param sourceRiverNoiseMap The source river noise map.
		///
		/// The destination image must exist throughout the lifetime of this
		/// object unless another image replaces that image.
		void SetSourceRiverNoiseMap(const NoiseMap& sourceRiverNoiseMap)
		{
			m_pSourceRiverNoiseMap = &sourceRiverNoiseMap;
		}
      ...
      private:
		...
		/// A pointer to the depth river source noise map.
		const NoiseMap* m_pSourceRiverNoiseMap;
