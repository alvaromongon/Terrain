...
//main ()
extern "C" __declspec(dllexport)  double BuildPlanet(double southCoord, double northCoord, double westCoord, double eastCoord, int gridSize, char* filePath) 
{
  ...
  int GRID_WIDTH = gridSize;//4096;

  // Height of elevation grid, in points.
  int GRID_HEIGHT = gridSize;//2048;
  ...
  const double MOUNTAIN_GLACIATION = 1.1;//1.375;
  ...
  const double RIVER_DEPTH = 0.1;//0.0234375;
  ...
  utils::Image image;
  renderer.SetSourceNoiseMap (elevGrid);
  ...
  writer.SetDestFilename(filePath);   //**********ADDED**********
  //writer.SetDestFilename ("heighMap.bmp");   //**********COMMENTED**********
