module Terrain.Localization {
    ...
    export function EnGB_Texts(): Terrain.Utilities.Dictionary<string> {
        var texts: Terrain.Utilities.Dictionary<string>;
        texts = new Terrain.Utilities.Dictionary<string>();
