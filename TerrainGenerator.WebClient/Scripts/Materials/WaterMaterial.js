    ...
    (function (Materials) {
        var WaterMaterial = (function (_super) {
            ...
            WaterMaterial.prototype.isReady = function (mesh, useInstances) {
                ...
                this._effect = engine.createEffect("Shaders/water", ["position", "normal", "uv"], ["worldViewProjection", "world", "view", "vEyePosition", "waterColor", "windMatrix", "waveData", "vLevels", "vLightPosition"], ["reflectionSampler", "refractionSampler", "bumpSampler"], "");
