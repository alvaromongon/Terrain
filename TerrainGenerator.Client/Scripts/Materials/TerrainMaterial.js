    ...
    (function (Materials) {
        var TerrainMaterial = (function (_super) {
            ...
            TerrainMaterial.prototype.isReady = function (mesh, useInstances) {
                ...
                this._effect = engine.createEffect("Shaders/Terrain/terrain", ["position", "normal", "uv", "type"], ["worldViewProjection", "world", "view", "vLightPosition", "vEyePosition", "waterColor", "windMatrix", "groundMatrix", "sandMatrix", "rockMatrix", "snowMatrix", "grassMatrix", "blendMatrix", "vLimits", "vClipPlane", "waveData", "vLevels"], ["reflectionSampler", "refractionSampler", "bumpSampler", "groundSampler", "sandSampler", "rockSampler", "snowSampler", "grassSampler", "blendSampler"], "");
                if (!this._effect.isReady()) {
                    return false;
                }
                return true;
            };
            TerrainMaterial.prototype.AddToRenderListRange = function (elementsToAdd) {
                if (elementsToAdd) {
                    var element;
